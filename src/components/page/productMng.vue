    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" icon="el-icon-plus" @click="add">添加产品</el-button>
            </div>
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="增益周期" align="center">
                </el-table-column>
                <el-table-column label="年化收益" align="center">
                </el-table-column>
                <el-table-column label="申购日" align="center">
                </el-table-column>
                <el-table-column label="产品总量" align="center">
                </el-table-column>
